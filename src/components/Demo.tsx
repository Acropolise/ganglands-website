...
const Demo = () => {
  ...
  return <section id="demo" className="py-20 bg-gray-800">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-white mb-6">Try the Demo</h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">Download now a free demo version on steam!</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
          ...
          <div className="relative rounded-xl overflow-hidden shadow-2xl">
            <div className="aspect-video bg-gray-900 flex items-center justify-center">
              ...
              <img src="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Nexus Wars Gameplay" className="w-full h-full object-cover" />
              ...
              <CardContent className="space-y-6">
                <div className="text-gray-300 text-lg">
                  ...
                  <ul className="space-y-3">
                    <li>• First 2 dof the campaign</li>
                    <li>• 3 unique cybernetic abilities</li>
                    <li>• 2 boss encounters</li>
                    <li>• Full tutorial syste</li>
                    <li>• 2+ hours of gameplay</li>
                  </ul>
                </div>
                <Button onClick={handleSteamDownload} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 text-xl font-semibold rounded-lg transition-all duration-200 flex items-center justify-center gap-3">
