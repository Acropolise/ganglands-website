...
const Hero = () => {
  ...
  useEffect(() => {
    videoRef.current?.play().catch(() => {
      // Autoplay might be blocked by browser; optionally show a play button
    });
  }, []);
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/3734080/f47bd0c425406c81537e759ed883e3219f8e733c/capsule_616x353.jpg?t=1750594845')",
      }}
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold text-white mb-6 animate-fade-in">
              Ganglands
            </h1>
            <p className="text-base md:text-lg lg:text-2xl text-slate-300 mb-8 animate-fade-in">
              In a city ruled by gangs, power means everything. Rob banks, raid
              houses, recruit gangsters, sell weed and dominate other gangs.
            </p>
