  ...
  return <section className="py-20 bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {/* Discord */}
          <Button onClick={handleDiscord} className="bg-purple-500 hover:bg-purple-700 text-white p-6 h-auto rounded-xl transition-all duration-200 flex flex-col items-center gap-3 group font-normal">
          ...
          {/* YouTube */}
          <Button onClick={handleYoutube} className="bg-red-600 hover:bg-red-700 text-white p-6 h-auto rounded-xl transition-all duration-200 flex flex-col items-center gap-3 group">
          ...
          {/* Steam */}
          <Button onClick={handleSteam} className="bg-blue-600 hover:bg-blue-700 text-white p-6 h-auto rounded-xl transition-all duration-200 flex flex-col items-center gap-3 group">
          ...
          {/* Instagram */}
          <Button onClick={handleInstagram} className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white p-6 h-auto rounded-xl transition-all duration-200 flex flex-col items-center gap-3 group">
